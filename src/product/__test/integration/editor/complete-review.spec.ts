...
describe('[Integration] 에디터 상품 검토 완료', () => {
    let productId = 0;
    let uri = '/products/complete-review/';
    const writerId = 2;
    describe('상품 검토 완료: SUCCESS', () => {
        ...
        it('상품 검토 완료시, HTTP Status 200 with OK', async () => {
            const editorToken =
    ...
    describe('상품 검토 완료: ERROR', () => {
        ...
        describe('[Forbidden] 인증되지 않은 Role', () => {
            it('검토요청된 상품을 작가가 승인하려고 할때, HTTP Status 403을 반환', async () => {
                const writerToken =
